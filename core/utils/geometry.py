...
def fit_footprint(points):
    """The smallest-area rectangle around the points seen from above, as
    (centre, size, yaw).

    One side of it lies along an edge of the points' convex hull. Yaw is kept
    within 45 degrees of map x, so an axis-aligned box comes back with yaw 0."""
